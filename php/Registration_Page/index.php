...
<body>
  ...
  <div class="d-flex justify-content-center align-content-center align-items-center">
    ...
    <form class="p-4 rounded" name="myform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
      ...
      <div class="form-group">
        ...
        <div id="msg-pass" class=" <?php if ($passErr == "") echo "d-none"  ?>  w-100   rounded border bg-error border-danger text-danger">
          <?php echo $passErr; ?>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <p id="msg-cpass" class=" <?php if ($cpassErr == "") echo "d-none"  ?>  w-100  text-center rounded border bg-error border-danger text-danger"> <?php echo $cpassErr; ?></p>
      </div>
